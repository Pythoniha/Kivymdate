...
class DatePickerFa(BaseDialog):
    ...
    def __init__(self,callback=None,**kwargs):
        ...
        self.day_names={
            '1': self.reshaper('شنبه'), 
            '2': self.reshaper('یکشنبه'),  
            '3': self.reshaper('دوشنبه'),     
            '4': self.reshaper('سه شنبه'),   
            '5': self.reshaper('چهارشنبه'),
            '6': self.reshaper('پنجشنبه'),
            '7': self.reshaper('جمعه'),
